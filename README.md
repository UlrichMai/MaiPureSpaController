...
This solution will allow you to control your Intex PureSpa<sup>tm</sup> SSP-H_20-1C from your iPhone/iPad/Watch using HomeKit. I tried to keep the hardware to a minimum, no PCB needed, but you need to open the display and do some soldering, which will void your warranty. 
...
## History
  ...
  Thanks to [tinwhisker/IntexSpaRemote](https://github.com/tinwhisker/IntexSpaRemote) I restarted by project this year 2020. I followed the interrupt driven approach and it worked! I also solved the problem to simulate the button push.
...
With the above information we can decode the data stream and read the temperature, see if the power, pump or heater is on.
...
![button timing](docs/board_settings.png)
